...
# 7 "./FunctionsHeader.h" 2



# 1 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\include\\c99\\stdbool.h" 1 3
# 10 "./FunctionsHeader.h" 2


# 1 "./BITS_Configuration.h" 1
...
# 20 "./KeyBoardLib.h"
char atrCaracter;
uint8_t atrStart, atrVarMax, atrVarMin, intV, intL, atrHisteresisMin, atrHisteresisMax;
...
uint8_t atrVarPorceso1, atrVarPorceso2;
...
# 14 "./FunctionsHeader.h" 2

# 1 "./LCD20x4Lib.h" 1
# 15 "./FunctionsHeader.h" 2
...
void I2CInit (uint32_t frecuencia);
void I2CStart (void);
...
# 16 "./FunctionsHeader.h" 2
# 26 "./FunctionsHeader.h"
...
# 4 "./LCD20x4Lib.h" 2
# 49 "./LCD20x4Lib.h"
uint8_t atrPosicionX = 3;
uint8_t atrPosicionY = 1;
uint8_t atrSetPoint1 = 50, atrHisteresis1 = 5, atrSetPoint2 = 50, atrHisteresis2 = 5;
...
# 79 "LCD20x4Lib.c"
        ...
        WriteCmdLCD(prmLCDtype);
        WriteCmdLCD(prmLCDtype);

        WriteCmdLCD(0b00001011&0b00001101&0b00001110);
        WriteCmdLCD(0b00001111&0b00001111&0b00001111);

        WriteCmdLCD(0x01);

        WriteCmdLCD(0b00010011);
...
# 130 "LCD20x4Lib.c"
            TRISD &= 0xf0;
            PORTD &= 0xf0;
            PORTD |= (((prmDDaddr | 0b10000000)>>4) & 0x0f);
...
void Delay1us( void ){_delay((unsigned long)((2)*(20000000/4000000.0)));return;}

void DelayPORLCD( void ){_delay((unsigned long)((25)*(20000000/4000.0)));return;}

void DelayLCD( void ){_delay((unsigned long)((7)*(20000000/4000.0)));return;}

void DelayExecution( void ){ _delay((unsigned long)((100)*(20000000/4000000.0)));return;}

void LCDgotoXY(int prmFila,int prmColumna)
{ switch (prmColumna){
        case 0:WriteCmdLCD(0b10000000 +prmFila);
        break;
        case 1:WriteCmdLCD(0b11000000 +prmFila);
        break;
        case 2:WriteCmdLCD(0b10010100 +prmFila);
        break;
        case 3:WriteCmdLCD(0b11010100 +prmFila);
        break;
        default:WriteCmdLCD(0b10000000 +prmFila);
    }
}

void LCDInit(void)
{ DelayPORLCD();
    LCDStart(0b00101111 & 0b00111011 );
    WriteCmdLCD( 0b00001111 & 0b00001101 & 0b00001110 );
    WriteCmdLCD(0x01);
    WriteCmdLCD(0x80);
