...
void DataProcess()
{
    atrVarMax=atrSetPoint1+atrHisteresis1;
    ...
    do{
        if(atrVarPorceso1>atrVarMax){
            PWM1_setDC(0);
            intV=adc_read(2);
            PWM2_setDC(intV);
        }
        if(atrVarPorceso1<atrVarMin){
            PWM2_setDC(0);
            intL=adc_read(1);
            PWM1_setDC(intL);
        }
...
void MostrarHumedad()
{
    ...
    WriteDataLCD('%');
    if(atrStart==0)
        WriteCmdLCD( 0b00001111 & 0b00001101 & 0b00001111 );
    LCDgotoXY(atrPosicionX,atrPosicionY);
}
void ConfigServoMotor()
{
    ...
    TMR0L=0XB0;
    LATCbits.LATC0=1;
    if(PORTEbits.RE1==1&&PORTEbits.RE0==0){
    ...
    else _delay((unsigned long)((1000)*(20000000/4000000.0)));
    LATCbits.LATC0=0;
    INTCONbits.TMR0IF=0;
}
void msDelay(unsigned int val)
